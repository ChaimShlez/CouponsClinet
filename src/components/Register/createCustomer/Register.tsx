...
function Register(props:IModal) {
    ...
    return (
        <div className="Register">
            ...
            <div className="wrapper">
                ...
                <Link to="/"><span className="icon-close" onClick={() => props.closeModal()}><IoClose /></span></Link>
                    ...
                    <form action="#">
                        ...
                        <div className="login-register">
                            <p>Already have an account?
                                ...
                                <div className="link" onClick={() => towFunctions()} >Login</div>
